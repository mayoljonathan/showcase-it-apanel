        ...
        new Promise(function (resolve) {
            ...
            if (result == 'enable' || result == 'disable') {
                ...
                new Promise(function (resolve, reject) {
                    ...
                    var msg = "Are you sure to " + confirmActionName_1 + " this app? The app will operate normally and will be seen on ShowcaseIT.";
                    if (result === 'disable') {
                        msg = "Are you sure to " + confirmActionName_1 + " this app? The app will be hidden in ShowcaseIT, and the developer of this app cannot send a content update request in this app. Continue?";
                    }
                ...
                new Promise(function (resolve, reject) {
                    ...
                    _this.dialogUtil.showConfirm('Are you sure to delete the app? Both the development app and the app listed in ShowcaseIT will be removed. This action cannot be undone.', buttons, '');
                }).then(function () {
...
StarComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'star',template:/*ion-inline-start:"C:\Users\pc\ShowcaseIT - Admin Panel\src\components\star\star.html"*/'<star-rating-comp [starType]="\'svg\'" \n                  [labelPosition]="\'top\'"\n                  [labelText]="labelText"\n                  [rating]="rating"\n                  [readOnly]="readOnly"\n                  [size]="size"\n                  [showHalfStars]="true"\n                  [hoverEnabled]="hoverEnabled"\n                  (onRatingChange)="onRatingChange($event)">\n</star-rating-comp>'/*ion-inline-end:"C:\Users\pc\ShowcaseIT - Admin Panel\src\components\star\star.html"*/
    }),
    __metadata("design:paramtypes", [])
], StarComponent);
...
var MainAppDetailsPage = (function () {
    ...
    MainAppDetailsPage.prototype.disableAppStatus = function () {
        ...
        var msg = 'Are you sure to disable the app? This app will be temporarily hidden in ShowcaseIT, and the developer of this app cannot send a content update request in this app. Continue?';
