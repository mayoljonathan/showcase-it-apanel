...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FilteredAppsPageModule", function() { return FilteredAppsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__filtered_apps__ = __webpack_require__(1340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_pipes_pipes_module__ = __webpack_require__(1306);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_components_module__ = __webpack_require__(1326);
...
var FilteredAppsPageModule = (function () {
    function FilteredAppsPageModule() {
    }
    return FilteredAppsPageModule;
}());
FilteredAppsPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__filtered_apps__["a" /* FilteredAppsPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__shared_pipes_pipes_module__["a" /* PipesModule */],
            __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__filtered_apps__["a" /* FilteredAppsPage */]),
        ],
    })
], FilteredAppsPageModule);

//# sourceMappingURL=filtered-apps.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FilteredAppsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_services___ = __webpack_require__(67);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var FilteredAppsPage = (function () {
    function FilteredAppsPage(navCtrl, navParams, appService, userService) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.appService = appService;
        this.userService = userService;
    ...
    FilteredAppsPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        ...
        this.appService.getAppsByCategory(this.category.uid)
            ...
            if (apps.length != 0) {
                apps.forEach(function (app) {
                    _this.userService.getUserData(app['user_uid']).takeWhile(function () { return _this.alive; }).subscribe(function (userData) {
    ...
    FilteredAppsPage.prototype.loadedAppIcon = function (index) {
        document.getElementById('app-icon-placeholder-' + index).className = '';
    };
    FilteredAppsPage.prototype.loadedUserPhoto = function (index) {
        document.getElementById('user-img-placeholder-' + index).className = '';
    };
    FilteredAppsPage.prototype.showMoreActions = function (i) {
    };
    FilteredAppsPage.prototype.ngOnDestroy = function () {
        this.alive = false;
    };
    return FilteredAppsPage;
}());
FilteredAppsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPage */])({ segment: ':type/:category_uid' }),
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-filtered-apps',template:/*ion-inline-start:"C:\Users\pc\ShowcaseIT - Admin Panel\src\pages\app-category-tabs\filtered-apps\filtered-apps.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>{{category?.name}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="bg">\n  <div class="flex-hv full-height" *ngIf="!apps;else loadedData">\n    <div class="loader"></div>\n  </div>\n\n  <ng-template #loadedData>\n    <app-list-table [apps]="apps" [hideCategory]="true"></app-list-table>\n\n    <!--<div padding class="container center">\n      <ion-card class="table-card-container">\n        <ion-row class="th-bg separator-bot">\n          <ion-col no-padding class="flex-hv">\n            <ion-item class="th-bg">\n              <ion-icon name="md-search" item-start></ion-icon>\n              <ion-input #searchBarInput placeholder="Search apps" clearInput></ion-input>\n            </ion-item>\n          </ion-col>\n        </ion-row>\n\n        <div class="flex-hv h-300" *ngIf="apps && apps?.length == 0">\n          <div>\n            <ion-icon md-name="filter_none" class="large-icon flex-h"></ion-icon>\n            <h2 class="size-18">There are currently no apps in this category.</h2>\n          </div>\n        </div>\n        \n        <ion-row class="scroll-x" *ngIf="apps && apps?.length > 0">\n          <table class="full-width">\n            <thead class="th-bg">\n              <th class=\'full-width\'>App name</th>\n              <th text-center width="50">Platforms</th>\n              <th>Date published</th>\n              <th text-center width="50">Status</th>\n              <th width="40"></th>\n            </thead>\n            <tbody>\n              <tr class="table-row" *ngFor="let a of (apps | sort:\'title\':\'asc\' | filter: searchBarInput.value:\'title\')" padding tappable>\n                <td class="table-name-container" (click)=\'navigateToApp(a)\'>\n                  <div class="app-icon-placeholder" [id]="\'app-icon-placeholder-\'+i">\n                    <img [src]="a?.thumbIconURL || a?.iconURL" alt="" (load)="loadedAppIcon(i)" class="app-icon">\n                  </div>\n                  <span class="table-name">{{a?.title}}</span>\n                </td>\n                <td text-center (click)=\'navigateToApp(a)\'>\n                  <ion-icon *ngIf="a?.platforms && a?.platforms?.web?.isCompatible" name="md-globe" class="mright-10 size-24"></ion-icon>\n                  <ion-icon *ngIf="a?.platforms && a?.platforms?.android?.isCompatible" name="logo-android" color="android" class="mright-10 size-24"></ion-icon>\n                  <ion-icon *ngIf="a?.platforms && a?.platforms?.desktop?.isCompatible" name="md-desktop" class="size-24"></ion-icon>\n                </td>\n                <td (click)=\'navigateToApp(a)\'>\n                  <span class="size-14">{{a?.datePublished | toFullDateAndTime}}</span>\n                </td>\n                <td text-center (click)=\'navigateToApp(a)\'>\n                  <ion-badge *ngIf="a.status === \'published\';" color="primary" class=\'size-14\'>Published</ion-badge>\n                  <ion-badge *ngIf="a.status === \'unpublished\';" color="disabled" class=\'size-14\'>Unpublished</ion-badge>\n                </td>\n                <td text-center (click)=\'showMoreActions(i)\'>\n                  <ion-icon name="md-more"></ion-icon>\n                </td>\n              </tr>\n            </tbody>\n          </table>\n        </ion-row>\n\n        <div class="flex-hv h-300" *ngIf="apps?.length!=0 && (apps | filter: searchBarInput.value:\'title\')?.length === 0">\n          <div>\n            <ion-icon md-name="search" class="large-icon flex-h"></ion-icon>\n            <h2 class="size-18">No apps matched in your search query.</h2>\n          </div>\n        </div>\n\n      </ion-card>\n    </div>-->\n  </ng-template>\n\n  \n</ion-content>\n\n'/*ion-inline-end:"C:\Users\pc\ShowcaseIT - Admin Panel\src\pages\app-category-tabs\filtered-apps\filtered-apps.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["w" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["y" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_2__shared_services___["b" /* AppService */],
...
//# sourceMappingURL=filtered-apps.js.map
