...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DetailedAppPageModule", function() { return DetailedAppPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__detailed_app__ = __webpack_require__(1357);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic2_material_icons__ = __webpack_require__(527);
...
var DetailedAppPageModule = (function () {
    function DetailedAppPageModule() {
    }
    return DetailedAppPageModule;
}());
DetailedAppPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__detailed_app__["a" /* DetailedAppPage */],
        ],
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__detailed_app__["a" /* DetailedAppPage */]),
        ],
    })
], DetailedAppPageModule);

//# sourceMappingURL=detailed-app.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DetailedAppPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_services___ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_utils___ = __webpack_require__(68);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DetailedAppPage = (function () {
    function DetailedAppPage(helperUtil, modalCtrl, dialogUtil, fileService, cacheService, appService, navCtrl, navParams) {
        ...
        // Read/Write?
        this.readOnly = false;
        this.type = ''; //publish_requests,content_update_requests
        this.duplicateApp = {
            old: {},
            new: {}
        };
    }
    DetailedAppPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        ...
        if (this.type === 'content_update_requests') {
            this.appService.getMainAppDetails(this.app.app_uid)
                ...
                .subscribe(function (oldData) {
                _this.duplicateApp['old'] = oldData;
            });
        ...
        this.appService.getCategoryData(this.app.appData.type, this.app.appData.category)
            ...
            _this.app.appData['category_name'] = category.name || '-';
        });
        if (!this.readOnly) {
            this.appService.getRequest(this.type, this.app.key)
                ...
                if (!r.app_uid) {
                    ...
                    setTimeout(function () {
                        _this.appService.getAppData(_this.app.app_uid, _this.app.user_uid).take(1).subscribe(function (appData) {
                            if (!appData.uid) {
                                return _this.navCtrl.pop();
                                // return this.navCtrl.setRoot('RequestTabsPage');
                            }
                            if (appData.request_status === 'cancelled' || appData.cu_request_status) {
                                _this.dialogUtil.showAlert('The request has been cancelled by the owner.', 'Ok', 'You have been redirected');
                                return _this.navCtrl.pop();
                                // return this.navCtrl.setRoot('RequestTabsPage') 
                            }
                            else {
                                // CHECK IF REQUEST IN LOG
                                _this.appService.getRequestInLog(_this.app.key).take(1).subscribe(function (request) {
                                    console.log(request);
                                    if (request[0].admin_uid !== _this.cacheService.admin_uid) {
                                        _this.dialogUtil.showAlert('The request has been processed by other admin. Check the logs for more informations.', 'Ok', 'You have been redirected');
                                        return _this.navCtrl.setRoot('RequestTabsPage');
                                    }
                                });
                            }
                        });
            ...
            this.showFabListener = setInterval(function () {
                _this.showFabButtonsHandler();
            }, 100);
        }
        this.loadedPage = true;
    };
    DetailedAppPage.prototype.toggleCUData = function () {
        this.viewingNewData = !this.viewingNewData;
        if (this.viewingNewData) {
            this.app.appData = this.duplicateApp.new;
        }
        else {
            this.app.appData = this.duplicateApp.old;
        }
    };
    DetailedAppPage.prototype.statusColor = function (status) {
        if (status === 'approve' || status === 'approve_cu') {
            return 'secondary';
        }
        return 'danger';
    };
    DetailedAppPage.prototype.actionName = function (action) {
    ...
    DetailedAppPage.prototype.onFabShowClick = function (fab, args) {
        if (args) {
            fab.close();
    ...
    DetailedAppPage.prototype.requestAction = function (action) {
        var _this = this;
        if (action != 1) {
            // action 2=reject,3=reject-remove
            var modal = this.modalCtrl.create('RequestRejectPage', { data: this.app, type: this.type, action: action });
        ...
        return new Promise(function (resolve, reject) {
            ...
            var msg = 'Are you sure to approve this publish request?';
            if (_this.type === 'content_update_requests') {
                msg = 'Are you sure to approve this content update request?';
            }
            _this.dialogUtil.showConfirm(msg, buttons, '');
        }).then(function () {
            // Check if request is still in publish_requests or content_update_requests
            _this.appService.getRequest(_this.type, _this.app.key).take(1).subscribe(function (r) {
                if (r.app_uid) {
                    var msg = 'Approving and publishing the app.';
                    var action_1 = 'approve';
                    if (_this.type === 'content_update_requests') {
                        msg = 'Approving and updating the app in ShowcaseIT.';
                        action_1 = 'approve_cu';
                    }
                    _this.dialogUtil.showLoader(msg);
                    var mailData = {
                        action: action_1,
                        email: _this.app.userData.email,
                        usersName: _this.app.userData.name,
                        appTitle: _this.app.appData.title,
                        appUid: _this.app.app_uid,
                        requestType: _this.type,
                    };
                    _this.appService.managePublishRequest(action_1, _this.app, _this.type, mailData).then(function (res) {
                        _this.dialogUtil.hideLoader();
                        if (res) {
                            var msg_1 = _this.type === 'publish_requests' ? 'App published successfully ' : 'App has been updated in ShowcaseIT ';
                            _this.dialogUtil.showToast(msg_1 + 'and an email has been sent to the owner.', 4000, 'bottom');
                            return _this.navCtrl.pop();
                            // return this.navCtrl.setRoot('RequestTabsPage',{},{
                            //   animate: true,
                            //   direction: 'backward'
                        ...
                        _this.dialogUtil.showToast('Error in doing the operation.', 3000, 'bottom');
                    }, function (e) {
                        _this.dialogUtil.hideLoader();
                        _this.dialogUtil.showToast("Error in doing the operation. Error: " + e, 3000, 'bottom');
                    });
                }
                else {
                    _this.dialogUtil.showToast('Error in doing the operation.', 3000, 'bottom');
    ...
    DetailedAppPage.prototype.showFabButtonsHandler = function () {
    ...
    DetailedAppPage.prototype.onScreenshotLoaded = function (index) {
        document.getElementById('shimmer-' + index).classList.remove('shimmer');
    };
    DetailedAppPage.prototype.loadedAppIcon = function () {
        document.getElementById('app-icon-placeholder').classList.remove('app-icon-placeholder');
    };
    DetailedAppPage.prototype.launchURL = function (url) {
        this.helperUtil.launchURL(url);
    };
    DetailedAppPage.prototype.launchEmail = function (email) {
        window.open('mailto:' + email);
        return false;
    };
    DetailedAppPage.prototype.copyText = function (text) {
        this.helperUtil.copyText(text);
        this.dialogUtil.showToast('Copied to clipboard', 3000, 'bottom');
    };
    DetailedAppPage.prototype.downloadFile = function (url) {
        this.fileService.downloadFile(url);
    };
    DetailedAppPage.prototype.viewMoreInfo = function () {
        var modal = this.modalCtrl.create('RequestRejectPage', { data: this.app, action: this.app.action, logInfo: true });
        return modal.present();
    };
    DetailedAppPage.prototype.removeFile = function (type, args) {
        var _this = this;
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.appService.removeFile(type, _this.app).then(function () {
                _this.dialogUtil.hideLoader();
    ...
    DetailedAppPage.prototype.viewRelease = function (release) {
        var modal = this.modalCtrl.create('ApkDetailsPage', { app_release: release, app_uid: this.app.uid });
        modal.present();
    };
    DetailedAppPage.prototype.navigateToUser = function (user_uid) {
        this.navCtrl.push('UserProfilePage', { uid: user_uid, isAdmin: false });
    };
    DetailedAppPage.prototype.deleteRelease = function (release) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var buttons = [
                { text: 'No', handler: reject },
            ...
            _this.appService.removeFile('remove_android_release', _this.app, release).then(function () {
                _this.dialogUtil.hideLoader();
    ...
    DetailedAppPage.prototype.scrollTo = function (path) {
        var el = document.getElementById("section-" + path);
        this.content.scrollTo(0, el.offsetTop, 800);
    };
    DetailedAppPage.prototype.ngOnDestroy = function () {
        this.alive = false;
        clearInterval(this.showFabListener);
    };
    return DetailedAppPage;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('fab'),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* FabContainer */])
], DetailedAppPage.prototype, "fab", void 0);
__decorate([
...
//# sourceMappingURL=detailed-app.js.map
