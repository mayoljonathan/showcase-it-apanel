...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_profile__ = __webpack_require__(1366);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_components_module__ = __webpack_require__(1326);
...
UserProfilePageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__user_profile__["a" /* UserProfilePage */]),
        ],
    })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_services__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_utils__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_request__ = __webpack_require__(274);
...
var UserProfilePage = (function () {
    function UserProfilePage(navCtrl, navParams, userService, appService, helperUtil, dialogUtil) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.userService = userService;
        this.appService = appService;
        ...
        this.isOnline = false;
        this.choices = [{ name: 'Active' }, { name: 'Banned' }, { name: 'Disabled' }];
    }
    ...
    UserProfilePage.prototype.getUserData = function () {
        var _this = this;
        this.pageLoaded = false;
        this.userService.getUserData(this.uid)
            .takeWhile(function () { return _this.alive; })
            .subscribe(function (userData) {
            _this.userService.getUserIsDeveloper(_this.uid).takeWhile(function () { return _this.alive; }).subscribe(function (res) {
                if (typeof res['$value'] === 'number') {
                    _this.user['developerSince'] = res.$value;
                    _this.isDeveloper = true;
                }
                else {
                    _this.isDeveloper = false;
                }
            });
            _this.appService.getUserShowcasedApps(_this.uid).takeWhile(function () { return _this.alive; }).subscribe(function (userApps) {
                _this.apps = userApps;
                _this.pageLoaded = true;
            });
            _this.userService.getUserPresence(_this.uid).takeWhile(function () { return _this.alive; }).subscribe(function (online) {
                console.log(online);
                if (online['$value'] === true) {
                    ...
                    _this.user['lastSeen'] = online.$value;
                }
            });
            _this.user = userData;
            _this.setRadioUserStatus();
        });
    };
    UserProfilePage.prototype.getAdminData = function () {
    };
    UserProfilePage.prototype.launchEmail = function () {
        if (this.user.email) {
            window.open('mailto:' + this.user.email);
            return false;
        }
    };
    UserProfilePage.prototype.getUserProvider = function () {
    ...
    UserProfilePage.prototype.setRadioUserStatus = function () {
    ...
    UserProfilePage.prototype.showStatusModal = function () {
        var _this = this;
        ...
        this.dialogUtil.showRadio(this.choices, ['Cancel', 'Ok'], "Set user's status to:").then(function (selection) {
            selection = selection.toLowerCase();
            if (_this.user.status !== selection) {
                var confirmActionName_1 = 'activate';
                var loaderActionName_1 = 'Activating';
                if (selection === 'banned') {
                    confirmActionName_1 = 'ban';
                    loaderActionName_1 = 'Banning';
                }
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    var msg = "Are you sure to " + confirmActionName_1 + " this user? The user will be logout automatically and will not be able login.";
                    if (selection === 'active') {
                        msg = "Are you sure to " + confirmActionName_1 + " this user? The user can now login normally.";
                    }
                    _this.dialogUtil.showConfirm(msg, buttons, '');
                }).then(function () {
                    _this.dialogUtil.showLoader(loaderActionName_1 + " user.");
                    _this.userService.setUserStatus(_this.user.uid, selection).then(function () {
                        _this.dialogUtil.hideLoader();
                        _this.dialogUtil.showToast('Success in doing the operation.', 3000, 'bottom');
                    }, function (e) {
                        _this.dialogUtil.hideLoader();
    ...
    UserProfilePage.prototype.getUserStatusColor = function () {
        if (this.user.status === 'active') {
            return 'primary';
        }
        else if (this.user.status === 'banned') {
    ...
    UserProfilePage.prototype.goToSocialAccount = function () {
        var _this = this;
        if (this.user.facebook_id) {
