...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__users_list__ = __webpack_require__(1365);
...
UsersListPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__users_list__["a" /* UsersListPage */]),
        ],
    })
], UsersListPageModule);
...
var UsersListPage = (function () {
    function UsersListPage(navCtrl, viewCtrl, events, navParams, appService, userService) {
        ...
        this.userService.getUsers('all')
            ...
            if (users.length != 0) {
                users.forEach(function (user) {
                    _this.userService.getUserPresence(user.uid).takeWhile(function () { return _this.alive; }).subscribe(function (online) {
                        //returns online.$value = true if its online, else an epoch time
                        user['lastSeen'] = online.$value;
                    });
                    _this.appService.getUserShowcasedApps(user.uid).takeWhile(function () { return _this.alive; }).subscribe(function (userApps) {
                        user['appCount'] = userApps.length;
                    });
                    _this.userService.getUserIsDeveloper(user.uid).takeWhile(function () { return _this.alive; }).subscribe(function (res) {
    ...
    UsersListPage.prototype.getUserStatusColor = function (user) {
