...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppsListPageModule", function() { return AppsListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__apps_list__ = __webpack_require__(1342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_pipes_pipes_module__ = __webpack_require__(1306);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic2_material_icons__ = __webpack_require__(527);
...
var AppsListPageModule = (function () {
    function AppsListPageModule() {
    }
    return AppsListPageModule;
}());
AppsListPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__apps_list__["a" /* AppsListPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__shared_pipes_pipes_module__["a" /* PipesModule */],
            __WEBPACK_IMPORTED_MODULE_4_ionic2_material_icons__["a" /* MaterialIconsModule */],
            __WEBPACK_IMPORTED_MODULE_5__components_components_module__["a" /* ComponentsModule */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__apps_list__["a" /* AppsListPage */]),
        ],
    })
], AppsListPageModule);

//# sourceMappingURL=apps-list.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AppsListPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_services___ = __webpack_require__(67);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var AppsListPage = (function () {
    ...
    AppsListPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad AppsListPage');
        this.getApps();
    };
    AppsListPage.prototype.getApps = function () {
        var _this = this;
        this.appService.getAllApps()
            ...
            if (apps.length != 0) {
                apps.forEach(function (app) {
                    _this.appService.getCategoryData(app.type, app.category).takeWhile(function () { return _this.alive; }).subscribe(function (category) {
    ...
    //   // });
    // }
    AppsListPage.prototype.ngOnDestroy = function () {
        this.alive = false;
    };
    return AppsListPage;
}());
AppsListPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPage */])({ segment: 'apps-list' }),
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-apps-list',template:/*ion-inline-start:"C:\Users\pc\ShowcaseIT - Admin Panel\src\pages\apps-list\apps-list.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu" color="light"></ion-icon>\n\n    </button>\n\n    <ion-title>Applications List</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="bg">\n\n  <div class="flex-hv full-height" *ngIf="!apps;else loadedData">\n\n    <div class="loader"></div>\n\n  </div>\n\n\n\n  <ng-template #loadedData>\n\n    <app-list-table [apps]="apps"></app-list-table>\n\n  </ng-template>\n\n\n\n  <!--<div padding class="container center" *ngIf="apps && apps?.length > 0">\n\n    <ion-card class="table-card-container">\n\n      <ion-row class="th-bg separator-bot">\n\n        <ion-col no-padding class="flex-hv">\n\n          <ion-item class="th-bg">\n\n            <ion-icon name="md-search" item-start></ion-icon>\n\n            <ion-input #searchBarInput placeholder="Search apps" clearInput></ion-input>\n\n          </ion-item>\n\n        </ion-col>\n\n      </ion-row>\n\n\n\n      <div class="flex-hv h-300" *ngIf="apps && apps?.length == 0">\n\n        <div>\n\n          <ion-icon md-name="apps" class="large-icon flex-h"></ion-icon>\n\n          <h2 class="size-18">There are currently no apps published yet.</h2>\n\n        </div>\n\n      </div>\n\n      \n\n      <ion-row class="scroll-x">\n\n        <table class="full-width">\n\n          <thead class="th-bg">\n\n            <th class=\'full-width\'>App name</th>\n\n            <th text-center width="50">Platforms</th>\n\n            <th width="150">Type/Category</th>\n\n            <th>Date published</th>\n\n            <th text-center width="50">Status</th>\n\n            <th width="40"></th>\n\n          </thead>\n\n          <tbody>\n\n            <tr class="table-row" *ngFor="let a of (apps | filter: searchBarInput.value:\'title\' | sort:\'datePublished\':\'desc\' );let i=index" padding tappable>\n\n              <td class="table-name-container" (click)=\'navigateToApp(i)\'>\n\n                <div class="app-icon-placeholder" [id]="\'app-icon-placeholder-\'+i">\n\n                  <img [src]="a.thumbIconURL || a.iconURL" alt="" (load)="loadedAppIcon(i)" class="app-icon">\n\n                </div>\n\n                <span class="table-name">{{a.title}}</span>\n\n              </td>\n\n              <td text-center (click)=\'navigateToApp(i)\'>\n\n                <ion-icon *ngIf="a.platforms && a.platforms.web?.isCompatible" name="md-globe" class="mright-10 size-24"></ion-icon>\n\n                <ion-icon *ngIf="a.platforms && a.platforms.android?.isCompatible" name="logo-android" color="android" class="mright-10 size-24"></ion-icon>\n\n                <ion-icon *ngIf="a.platforms && a.platforms.desktop?.isCompatible" name="md-desktop" class="size-24"></ion-icon>\n\n              </td>\n\n              <td (click)=\'navigateToApp(i)\'>\n\n                <span text-capitalize>{{a?.type}}/{{a?.category_name}}</span>\n\n              </td>\n\n              <td (click)=\'navigateToApp(i)\'>\n\n                <span class="size-14">{{a.datePublished | toFullDateAndTime}}</span>\n\n              </td>\n\n              <td text-center (click)=\'navigateToApp(i)\'>\n\n                <ion-badge *ngIf="a.status === \'published\';" color="primary" class=\'size-14\'>Published</ion-badge>\n\n                <ion-badge *ngIf="a.status === \'unpublished\';" color="disabled" class=\'size-14\'>Unpublished</ion-badge>\n\n              </td>\n\n              <td text-center (click)=\'showMoreActions(i)\'>\n\n                <ion-icon name="md-more"></ion-icon>\n\n              </td>\n\n            </tr>\n\n          </tbody>\n\n        </table>\n\n      </ion-row>\n\n\n\n      <div class="flex-hv h-300" *ngIf="apps?.length!=0 && (apps | filter: searchBarInput.value:\'title\')?.length === 0">\n\n        <div>\n\n          <ion-icon md-name="search" class="large-icon flex-h"></ion-icon>\n\n          <h2 class="size-18">No apps matched in your search query.</h2>\n\n        </div>\n\n      </div>\n\n\n\n    </ion-card>\n\n  </div>-->\n\n  \n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\pc\ShowcaseIT - Admin Panel\src\pages\apps-list\apps-list.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__shared_services___["b" /* AppService */],
        __WEBPACK_IMPORTED_MODULE_2__shared_services___["f" /* UserService */]])
], AppsListPage);

//# sourceMappingURL=apps-list.js.map
