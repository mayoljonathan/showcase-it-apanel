...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__login__ = __webpack_require__(855);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_email_validator__ = __webpack_require__(856);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_models___ = __webpack_require__(857);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_services___ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_utils___ = __webpack_require__(47);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginPage = (function () {
    function LoginPage(navCtrl, navParams, menuCtrl, cacheService, dialogUtil, adminService) {
        ...
        this.admin.email = 'tsebvaan321@gmail.com';
        this.admin.password = '123456';
    }
                ...
                if (res) {
                    _this.adminService.getAdminData(res.uid).then(function (adminData) {
                        ...
                        if (adminData.status === 'disabled') {
                            ...
                            _this.navCtrl.setRoot('AnalyticsPage');
                            setTimeout(function () {
...
LoginPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-login',template:/*ion-inline-start:"C:\Users\pc\ShowcaseItAdmin\src\pages\login\login.html"*/'<ion-content class="default-bg">\n\n  <div class="login-container">\n    <ion-card padding>\n      <ion-card-header>\n        <div class="logo-container"></div>\n        <h1 class="title" text-center text-wrap>Showcase It - Admin Panel</h1>\n      </ion-card-header>\n\n      <ion-card-content padding>\n        <ion-item no-padding>\n          <ion-label floating>Email address</ion-label>\n          <ion-input type="email" [(ngModel)]="admin.email"></ion-input>\n        </ion-item>\n\n        <ion-item no-padding>\n          <ion-label floating>Password</ion-label>\n          <ion-input type="password" [(ngModel)]="admin.password"></ion-input>\n        </ion-item>\n        <ion-item no-padding>\n          <ion-label color="primary">\n            <span (click)="forgotPassword()" tappable class="size-14">Forgot Password?</span>\n          </ion-label>  \n        </ion-item>\n\n        <ion-row margin-top class="flex-h">\n          <button class="round-button" (click)="signIn()">\n            <ion-icon class="medium-icon" name="md-arrow-forward" color="primary-text"></ion-icon>\n          </button>\n        </ion-row>\n\n      </ion-card-content>\n\n    </ion-card>\n  </div>\n\n</ion-content>\n'/*ion-inline-end:"C:\Users\pc\ShowcaseItAdmin\src\pages\login\login.html"*/,
    }),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_model__ = __webpack_require__(858);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__admin_model__ = __webpack_require__(859);
