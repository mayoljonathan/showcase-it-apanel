...
StartupLoadingPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-startup-loading',template:/*ion-inline-start:"C:\Users\pc\ShowcaseItAdmin\src\pages\startup-loading\startup-loading.html"*/'<ion-content class="bg">\n  <div class="full-height flex-hv">\n    <div class="grid-center" *ngIf="connectionError">\n      <ion-icon name="close" class="large-icon"></ion-icon>\n      <span>Please check your internet connection.</span>\n      <button ion-button class="half-width center mtop-5" (click)="retry()">Retry</button>\n    </div>\n    <div class="grid-center" *ngIf="!connectionError">\n      <div class="loader"></div>\n    </div>\n  </div>\n</ion-content>'/*ion-inline-end:"C:\Users\pc\ShowcaseItAdmin\src\pages\startup-loading\startup-loading.html"*/,
    }),
