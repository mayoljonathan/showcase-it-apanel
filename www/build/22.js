...
var AddAdministratorPage = (function () {
    ...
    AddAdministratorPage.prototype.submitForm = function (form) {
        ...
        if (form.valid) {
            ...
            data_1['superAdmin'] = this.admin.isSuperAdmin;
